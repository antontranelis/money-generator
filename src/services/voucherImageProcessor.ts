...
function findOuterEdges(
  ...
  // Threshold: anything brighter than this is considered "not black"
  // Black background is ~0, voucher content is much brighter
  // Using 80 to be less sensitive and avoid detecting dark edges of vouchers
